-- Phase 1: Complete Scoring Metadata Migration
-- Goal: Populate remaining NULL scores, and backfill reasoning/model_input_context for all choices
...
update public.question_choices qc
set score = round(((r.seq_eff - r.min_seq)::double precision / nullif((r.max_seq - r.min_seq),0)) * 100, 2)
from ranked r
