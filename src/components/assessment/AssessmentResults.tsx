    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        <div className="bg-gradient-primary bg-clip-text text-transparent">
          <h1 className="text-4xl font-bold">{t("assessment.results.heading")}</h1>
        </div>
      ...
      <Card className="p-8 space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-green-600">{t("assessment.results.strengths")}</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-orange-600">{t("assessment.results.areasForImprovement")}</h3>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
