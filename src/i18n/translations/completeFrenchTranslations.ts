...
export const frenchTranslations: Record<string, TranslationEntry> = {
  ...
  M3: {
    ...
    options: [
      ...
      { value: "C-level executive", label: "Cadre dirigeant·e" },
      { value: "Head of Marketing", label: "Responsable Marketing" },
      { value: "Head of Sales", label: "Responsable Commercial" },
      { value: "Head of Finance", label: "Responsable Finance" },
      { value: "Head of Operations", label: "Responsable Opérations" },
      ...
      { value: "Infrastructure Manager", label: "Responsable Infrastructure" },
      { value: "Legal / Compliance Lead", label: "Responsable Juridique / Conformité" },
      { value: "Privacy Officer", label: "Responsable Protection des Données" },
      { value: "Compliance Manager", label: "Responsable Conformité" },
      { value: "Risk Manager", label: "Responsable Risques" },
      { value: "Audit Lead", label: "Responsable Audit" },
      { value: "Governance Officer", label: "Responsable Gouvernance" },
